...
// REVOCATO (reset password, logout-all) → 401.
...
// POST /api/auth/logout-all — invalida TUTTI i JWT esistenti incrementando
// tokenVersion. Utile se l'utente sospetta che il proprio account sia
// stato compromesso o vuole sloggare un dispositivo perso.
