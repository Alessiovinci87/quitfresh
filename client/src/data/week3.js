...
export const week3 = [
  ...
  },
  {
    ...
    scenes: [
      ...
      { type: 'notice', text: 'Cosa noti, ora, in chi accende una sigaretta senza pensarci.' },
    ],
    body: null,
  },
  {
    ...
    cta: CTA_DEFAULT,
    scenes: [
      { type: 'title', text: 'Pensavi: senza una sigaretta, in certi momenti, non reggo.' },
      { type: 'thought', text: 'Poi uno di quei momenti è arrivato. E l’hai attraversato.' },
      { type: 'break', text: 'È passato lo stesso.' },
      { type: 'thought', text: 'La sigaretta non l’avrebbe risolto. Avrebbe solo aggiunto fumo al momento.' },
