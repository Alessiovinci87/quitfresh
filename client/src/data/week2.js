...
export const week2 = [
  {
    ...
    scenes: [
      ...
      { type: 'notice', text: 'È sempre stato lì. Non lo vedevi.' },
    ],
    body: null,
  },
  {
    ...
    interaction: {
      ...
      options: [
        { label: 'Ragionevole', feedback: 'Il tono pacato è la sua arma migliore. Più sembra logica, meno la metti in dubbio.' },
        { label: 'Urgente', feedback: 'L’urgenza è finta. Niente di vero ti chiede di decidere adesso, subito.' },
        { label: 'Quasi gentile', feedback: 'Sembra dalla tua parte. È il travestimento che la fa entrare.' },
      ],
    },
  ...
  },
  {
    ...
    scenes: [
      ...
      { type: 'notice', text: 'Dieci minuti. Il corpo non aveva bisogno di niente.' },
    ],
    body: null,
  },
  {
