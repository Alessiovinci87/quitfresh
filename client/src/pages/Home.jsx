      ...
      <div className="flex-1 flex flex-col items-center justify-center py-2">
        {loading ? (
          ...
          <>
            ...
            <button
              onClick={() => setShowStreakSheet(true)}
              className="mt-3 inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-white border border-sage-200 shadow-soft text-xs font-medium text-sage-800 hover:bg-sage-50 active:scale-95 transition-all"
            >
